...
public class GroupMessengerProvider extends ContentProvider  {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
         ...
         */
        //References:
        //https://stackoverflow.com/questions/9435158/how-to-populate-listview-from-matrix-cursor
        //
        ...
        try {
            ...
            //Log.i(TAG,valueToRead);
            //Log.i(TAG,selection);
            inputStream.close();
            matrixCursor.addRow(new Object[] { selection,valueToRead});
        } catch (Exception e) {
